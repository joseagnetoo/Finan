                ...
                <div class="col-sm-6">
                    <div class="wrapper fadeInDown">
                        <div id="formContent">
                            ...
                            <!--<img src="../IMAGES/iconWallet.png" style="width: 80px" id="icon" alt="User Icon" /> -->
                            <h2><img src="../IMAGES/iconWallet.png" style="width: 40px" id="icon" alt="User Icon" /> SE REGISTRE</h2>
                            </div>
                            ...
                            <!-- Remind Passowrd -->
                            <div id="formFooter">
                            <a class="underlineHover" href="./login.php">Logar-se</a>
                            </div>
